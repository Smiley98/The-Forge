...
struct Fragment_Shader
{
    ...
    Fragment_Shader(constant Uniforms_ShadowUniformBuffer& ShadowUniformBuffer, texture2d<float> ShadowTexture, sampler clampMiplessLinearSampler) :
...
struct ArgBuffer0
{
    ...
    texture2d<float> ShadowTexture [[id(14)]];
};

struct ArgBuffer1
{
    constant Fragment_Shader::Uniforms_ShadowUniformBuffer& ShadowUniformBuffer [[id(2)]];
};
    ...
    constant ArgBuffer1& argBuffer1 [[buffer(1)]])
{
    ...
    Fragment_Shader main(argBuffer1.ShadowUniformBuffer, argBuffer0.ShadowTexture, argBuffer0.clampMiplessLinearSampler);
